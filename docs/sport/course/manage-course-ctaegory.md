...
1. 從 sideMenu 點擊 APP 課程管理，展開選單後，點擊 一般運動 進入一般運動項目列表
   ![alt text](img/add-course-category-01.png)

2. 點選 新增項目
   ![alt text](img/add-course-category-02.png)
...
1. 點選 編輯 目標運動項目
   ![alt text](img/edit-course-category-01.png)

2. 進入運動項目頁面，可以修改項目資訊，下方可檢視該項目內的運動課程列表。課程管理參考 [運動課程管理](./course-manage.md)。
   ![alt text](img/edit-course-category-02.png)

### 刪除運動項目

1. 點選 刪除 目標運動項目
   ![alt text](img/delete-course-category-01.png)

2. 二次確認彈窗，點選 確認刪除
   :::danger
   刪除後無法還原，請謹慎操作。
   :::
   ![alt text](img/delete-course-category-02.png)
