...
| 欄位     | 驗證 | 限制                                                                                                                                                      |
| -------- | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 文章標題 | 必填 | 必須為文字，中文上限25字。<br/>多語系設定(選填)：可新增 簡體中文 與 英文 文章標題。                                                                       |
| 引言     | 必填 | 必須為文字，中文上限255字。<br/>引言輸入時不可斷行。<br/>多語系設定(選填)：可透過欄位上方之語系切換按鈕（ZH/CH/EN，預設語系必填）進行填寫各語系引言內容。 |
...
| 內文段落 | 必填 | 至少須有一個段落，段落標題及內容皆不可為空<br/>多語系設定(選填)：可透過欄位上方之語系切換按鈕（ZH/CH/EN，預設語系必填）進行填寫各語系內容段落。           |
...
- 多語系設定：可新增 簡體中文 與 英文 文章標題。

### 引言

- 吸引讀者進來看的簡短內容。
- 可透過欄位上方之語系切換按鈕（ZH/CH/EN，預設語系必填）進行填寫各語系引言內容。
...
- 段落標題：段落的小標，建議小於 15 字，前端網頁檢視文章時可以段落為單位快速選擇要閱讀的段落。<br/>編輯時可透過欄位上方之語系切換按鈕（ZH/CH/EN，預設語系必填）進行填寫各語系內容段落。
